# LaTeX-PhD Proposal Template  - Christ (Deemed to be University)
...
### Demonstrations
- Template Demo in Overleaf: [Template](https://www.overleaf.com/read/cybgdzwxvxhf)


### Download
- Clone: 
`$ git clone https://github.com/venkataswamyr/LaTeX-PhD_Proposal_Template-Christ_University`
